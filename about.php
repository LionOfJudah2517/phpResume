...
<div class = "container" id="content">
  <div class="pageTitle">
    <h1 class = "col-md-12 text-center"> <strong>MY WORK EXPERIENCE</strong></h1>
  </div><!-- pageTitle -->
    <hr>
    <div class="row">
    <h3 class ="col-md-4"> Education: </h3>
    <br>
    <br>
    </div>
    <div class = "col-md-12">
      <div class="col-md-6 text-center">
        <p><strong>Quincy College | CURRENT | ASSOCIATES</strong></p>
        <p>Computer Science - Programming</p>
      </div>
      <div class="col-md-6 text-center">
        <p><strong>Udacity | MARCH 2017 | CERTIFICATION</strong></p>
        <p>Front-end Nanodgree Certification</p>
      </div>
    </div>
